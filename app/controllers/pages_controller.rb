class PagesController < ApplicationController
  ...
  def new
		@alerts = Alerts.new(alert_type: "TEST", emergency_type: "TEST", affected_areas: "NONE", alert_message: "Generic Message", user: "", status: "")
	end
...
=end
  ...
  def create_alert
    @alerts = Alerts.new(alert_type: $alert_selected, emergency_type: $emergency_selected, affected_areas: "NONE", alert_message: "Generic Message", user: $current_user, status: "active")
    if @alerts.save
